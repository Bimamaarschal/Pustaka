                            ...
                            <div class="w-full px-4">
                                <div class="mb-12 lg:mb-15">
                                    <div class="pb-5"
                                        ...
                                        <h1 class="text-2xl font-medium md:text-[20px] text-dark-500">
                                            Poin :
                                        </h1>
                                    </div>
                                    <p class="mb-8 lg:mb-11 md:text-[13px] text-gray-600 ">
                                        ...
                                        dalam memperbaiki dan memperkaya konten dari dokumen-dokumen ini.
                        ...
                        <div class="flex flex-wrap -mx-4">
                            ...
                            <div class="w-full md:w-1/2 lg:w-1/4 px-4">
                                <div class="bg-white mb-5 group wow fadeInUp" data-wow-delay=".1s">
                                    <div class=" w-[70px] h-[70px] flex items-center justify-center bg-red-500 rounded-md mb-8 relative z-10">
                                        <span class=" w-[70px] h-[70px] flex items-center justify-center  bg-red-500 bg-opacity-20 rounded-md mb-5 absolute  z-[-1] top-0 left-0 rotate-[0deg] group-hover:rotate-45 duration-300"></span>
                                    ...
                                    <p class="mb-8 lg:mb-11 md:text-[13px] text-gray-500 ">
                            ...
                            <div class="w-full md:w-1/2 lg:w-1/4 px-4">
                                <div class="bg-white mb-5 group wow fadeInUp" data-wow-delay=".1s">
                                    ...
                                    <p class="mb-8 lg:mb-11 md:text-[13px] text-gray-500 ">
                                        Artikel-artikel ini mencakup beragam topik dan penelitian yang relevan dengan
                                        berbagai bidang ilmu.
                                    </p>
                                    <p class="mt-4 text-sm">
                                        <a href="{{ route('timreview.artikels') }}"
                                            class="inline-flex items-center font-semibold">
                                            Lihat Dokumen
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"
                                                class="ml-1 w-5 h-5 ">
