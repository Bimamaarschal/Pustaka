            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                                ...
                                <div class="mb-12 lg:mb-15">
                                    <div class="pb-10"
                                        ...
                                        <a href="{{ route('beritas.create')}}"
                                            class="bg-red-500 mb-15 text-white px-6 py-2 rounded">Ajukan berita Baru</a>
                                    </div>
                                    <p class="
                                                text-lg
                                                sm:text-xl
                                                ...
                                                text-gray-600
                                                ">
                                        Selamat datang di PUSTAKA berita, Nikmati fitur berita
                                        yang menyediakan akses mudah ke ribuan berita terkini dari berbagai bidang
                                        ilmu.<br>
                                        Baca berita online dari kenyamanan rumah Anda dan berkontribusi dengan
                                        partisipasi tambah berita untuk berbagi pengetahuan orisinal.
                                    </p>
                                </div>
                            </div>
                        </div>
                ...
                ">
                  ...
                  "></span>
                                    ...
                                    <p class=" text-gray-500 mb-8 lg:mb-11 md:text-[15px]">
                                        Halaman berisi kumpulan berita dengan tema/kategori teknologi.
                                    </p>
                ...
                ">
                  ...
                  "></span>
                                    ...
                                    <p class="text-gray-500 mb-8 lg:mb-11 md:text-[15px]">
                                        Halaman berisi kumpulan berita dengan tema/kategori bisnis.
                                    </p>
                                    <p class="mt-4 text-sm">
                ...
                ">
                  ...
                  "></span>
                                    ...
                                    <p class="text-gray-500 mb-8 lg:mb-11 md:text-[15px]">
                                        Halaman berisi kumpulan berita dengan tema/kategori ekonomi.
                                    </p>
                                    <p class="mt-4 text-sm">
                                        <a href="https://laravel.com/docs"
                                            class="inline-flex items-center font-semibold">
                ...
                ">
                  ...
                  "></span>
                                    ...
                                    <p class="text-gray-500 mb-8 lg:mb-11 md:text-[15px]">
                                        Halaman berisi kumpulan berita dengan tema/kategori sejarah.
                                    </p>
                                    <p class="mt-4 text-sm">
                                        <a href="https://laravel.com/docs"
                                            class="inline-flex items-center font-semibold">
                ...
                <section class="p-10 lg:pt-[5px]">
                                ...
                                <div class="mb-10 group wow fadeInUp" data-wow-delay=".1s">
                                    <div class="rounded overflow-hidden mb-8" style="width: 350px; height: 220px;">
                                        <a href="{{ route('beritas.show', $berita->id) }}" class="block">
                                            <img src="{{ asset('storage/beritas/' . $berita->image) }}" alt="image"
                  ...
                  ">
                                        ...
                                        <h3>
                                            <a href="{{ route('beritas.show', $berita->id) }}" class="
                      font-semibold
                      text-xl
                      sm:text-2xl
                      lg:text-xl
