                    ...
                    <form action="{{ route('beritas.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div class="mb-6">
                                ...
                                <input type="text" placeholder="Judul Berita" class="w-full rounded-md border border-[#E9EDF4] py-3 px-5 bg-[#FCFDFE] text-base text-gray-600 placeholder-[#ACB6BE] outline-none focus-visible:shadow-none focus:border-red-500 focus:ring-red-500 transition" name="judulberita" value="{{ old('judulberita') }}" id="judulInput" />
                        ...
                        <div class="mb-6">
                            ...
                            <input name="konten" placeholder="Kata pembuka" class="w-full rounded-md border border-[#E9EDF4] py-3 px-5 bg-[#FCFDFE] text-base text-gray-600 placeholder-[#ACB6BE] outline-none focus-visible:shadow-none focus:border-red-500 focus:ring-red-500 transition" value="{{ old('konten') }}"/>
