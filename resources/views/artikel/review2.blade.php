    ...
    <div class="py-2 pb-12 ">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <div class="p-6  mb-5 lg:p-8 bg-white">
                    <div style="display: flex; justify-content: space-between; align-items: center;">
                        <h1 class="text-2xl font-medium text-dark-500" style="flex-grow: 1;">Artikel Anda</h1>
                    ...
                    <div class="m-10">
                        <iframe class="rounded-lg wow w-full h-50" src="{{ asset('storage/pdfartikel/' . $artikel->pdfhasil) }}" height="600"></iframe>
                    </div>
                    <button type="button" class=" next-step float-right bg-red-500 m-10  text-white px-6 py-2 rounded" data-step="2"> Kirim Artikel</button>
                </div>
