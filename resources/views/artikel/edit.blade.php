            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <div class="mb-12 p-6 pb-10 lg:p-8 bg-white ">
                    ...
                    <div class="pb-10" style="display: flex; justify-content: space-between; align-items: center;">
                        <h1 class="text-2xl font-medium text-dark-500" style="flex-grow: 1;">Edit Artikel </h1>
                        <a href="{{ route('artikels.review2', ['id' => $artikel->id]) }}" class="border mr-2 border-red-500 rounded text-red-500 px-2 py-2">
                    ...
                    <form id="multiStepForm" action="{{ route('artikels.update', ['artikel' => $artikel->id]) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="step" data-step="1">
                            <div class="mb-6">
                                ...
                                <input name="noartikel" placeholder="No ID Artikel" class="w-full pointer-events-none rounded-md border border-[#E9EDF4] py-3 px-5 bg-[#FCFDFE] text-base text-gray-600 placeholder-[#ACB6BE] outline-none focus-visible:shadow-none focus:border-red-500 focus:ring-red-500 transition" value="{{  $artikel->noartikel }}"/>
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <input type="text" placeholder="Instansi" class=" w-full rounded-md border border-[#E9EDF4] py-3 px-5 bg-[#FCFDFE] text-base text-gray-600 placeholder-[#ACB6BE] outline-none focus-visible:shadow-none  focus:border-red-500 focus:ring-red-500 transition" name="instansi" value="{{  $artikel->instansi }}" />
                                </div>
                            ...
                            <div class="mb-10">
                                ...
                                <select name="jenis" value="{{  $artikel->jenis }}" class=" w-full rounded-md  border border-[#E9EDF4] py-3  px-5 bg-[#FCFDFE] text-base text-gray-600 placeholder-[#ACB6BE] outline-none focus-visible:shadow-none focus:border-red-500 focus:ring-red-500  transition">
                                    <option class="text-gray-500 text-sm " value="" disabled>Pilih kategori </option>
                        ...
                        <div class="step" data-step="2">
                            <div class="mb-6">
                                ...
                                <input name="judul" placeholder="Judul" class="w-full rounded-md border border-[#E9EDF4] py-3 px-5 bg-[#FCFDFE] text-base text-gray-600 placeholder-[#ACB6BE] outline-none focus-visible:shadow-none focus:border-red-500 focus:ring-red-500 transition" value="{{  $artikel->judul }}"/>
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <div class="mb-6">
                                    ...
                                    <input type="text" placeholder="Kata Keterangan" class="w-full rounded-md border border-[#E9EDF4] py-3 px-5 bg-[#FCFDFE] text-base text-gray-600 placeholder-[#ACB6BE] outline-none focus-visible:shadow-none focus:border-red-500 focus:ring-red-500 transition" name="kataketerangan" value="{{  $artikel->kataketerangan }}" id="kataketerangan" />
                                ...
                                <div class="mb-6">
                                    ...
                                    <div class="col-span-12 mb-2">
                                        ...
                                        <input type="file" name="image" placeholder="Pilih gambar representasi anda" class="block w-full  rounded-md border border-[#E9EDF4] text-sm text-slate-500 file:mr-4 file:py-3.5 file:px-20 file:rounded-md file:border-0 file:text-sm file:font-semibold file:bg-red-500 file:text-white" value="{{  $artikel->image }}"/>
                                        @error('image')
                                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                                        @enderror
                                    </div>
                            ...
                            <div class="mb-6">
                                ...
                                <textarea name="abstrak" id="abstrak" placeholder="Abstrak Artikel" class="w-full rounded-md border border-[#E9EDF4] py-3 px-5 bg-[#FCFDFE] text-base text-gray-600 placeholder-[#ACB6BE] outline-none focus-visible:shadow-none focus:border-red-500 focus:ring-red-500 transition" >{{  $artikel->abstrak }}</textarea>
                            ...
                            <div class="mb-10">
                                ...
                                <input name="katakunci" id="kata-kunci-container" class="w-full pointer-events-none rounded-md border border-[#E9EDF4] py-3 px-3 bg-[#FCFDFE] text-base text-gray-600 placeholder-[#ACB6BE] outline-none focus-visible:shadow-none focus:border-red-500 focus:ring-red-500 transition mt-2" value="{{  $artikel->katakunci }}">
                            </div>
                        ...
                        <div class="step" data-step="3">  
                            <div class="pb-10">
                                ...
                                <textarea name="latarbelakang" id="latarbelakang" placeholder="Latar Belakang Artikel" class="w-full rounded-md border border-[#E9EDF4] h-80 py-3 px-5 bg-[#FCFDFE] text-base text-gray-600 placeholder-[#ACB6BE] outline-none focus-visible:shadow-none focus:border-red-500 focus:ring-red-500 transition" >{{  $artikel->latarbelakang }}</textarea>
                                @error('latarbelakang')
                                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="step" data-step="4">
                            <div class="pb-10">
                                ...
                                <textarea name="metode" id="metode" placeholder="Metode Artikel yang digunakan" class="w-full rounded-md border border-[#E9EDF4] py-3 px-5 bg-[#FCFDFE] text-base text-gray-600 placeholder-[#ACB6BE] outline-none focus-visible:shadow-none focus:border-red-500 focus:ring-red-500 transition">{{  $artikel->metode }}</textarea>
                                @error('metode')
                                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="step" data-step="5">
                            <div class="mb-6">
                                ...
                                <textarea name="hasil" id="hasil" placeholder="Hasil Penelitian Artikel" class="w-full rounded-md border border-[#E9EDF4] py-3 px-5 bg-[#FCFDFE] text-base text-gray-600 placeholder-[#ACB6BE] outline-none focus-visible:shadow-none focus:border-red-500 focus:ring-red-500 transition">{{  $artikel->hasil }}</textarea>
                                @error('hasil')
                                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="mb-6">
                                ...
                                <textarea name="pembahasan" id="pembahasan" placeholder="Pembahasan Artikel yang digunakan" class="w-full rounded-md border border-[#E9EDF4] py-3 px-5 bg-[#FCFDFE] text-base text-gray-600 placeholder-[#ACB6BE] outline-none focus-visible:shadow-none focus:border-red-500 focus:ring-red-500 transition" >{{  $artikel->pembahasan }}</textarea>
                                @error('pembahasan')
                                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="step" data-step="6">
                            <div class="mb-6">
                                ...
                                <textarea name="simpulan" id="simpulan" placeholder="Kesimpulan Artikel" class="w-full rounded-md border border-[#E9EDF4] py-3 px-5 bg-[#FCFDFE] text-base text-gray-600 placeholder-[#ACB6BE] outline-none focus-visible:shadow-none focus:border-red-500 focus:ring-red-500 transition">{{  $artikel->simpulan }}</textarea>
                                @error('simpulan')
                                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="mb-6">
                                ...
                                <textarea name="saran" id="saran" placeholder="Saran" class="w-full rounded-md border border-[#E9EDF4] py-3 px-5 bg-[#FCFDFE] text-base text-gray-600 placeholder-[#ACB6BE] outline-none focus-visible:shadow-none focus:border-red-500 focus:ring-red-500 transition" >{{  $artikel->saran }}</textarea>
                                @error('saran')
                                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="step" data-step="7">
                            <div class="mb-6">
                                ...
                                <textarea name="referensi" id="referensi" placeholder="Referensi" class="w-full rounded-md border border-[#E9EDF4] py-3 px-5 bg-[#FCFDFE] text-base text-gray-600 placeholder-[#ACB6BE] outline-none focus-visible:shadow-none focus:border-red-500 focus:ring-red-500 transition">{{  $artikel->referensi }}</textarea>
                                @error('referensi')
                                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                                @enderror
                            </div>
