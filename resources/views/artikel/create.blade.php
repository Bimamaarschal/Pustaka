            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <div class="p-6 pb-10 lg:p-8 bg-white border-b border-gray-200">
                    ...
                    <p class="flex items-center space-x-2 text-sm pb-8 text-gray-500">
                        ...
                        <span>Dengan mengajukan penyimpanan artikel, Anda menyetujui kebijakan komunitas kami dan
                            bersedia mematuhi kebijakan tersebut.<br> Setelah di review oleh tim kami Artikel akan
                    ...
                    <form action="{{ route('artikels.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div class="mb-6">
                                ...
                                <input type="text" placeholder="Penulis" class="
                                w-full
                                                    rounded-md
                                                    border
                                                    border-[#E9EDF4]
                ...
                " name="penulis" />
                            ...
                            <div>
                                ...
                                <input type="text" placeholder="Tanggal"
                                    value="{{ \Carbon\Carbon::now()->format('d - M - Y') }}" class=" w-full rounded-md border border-[#E9EDF4] py-3 px-5 bg-[#FCFDFE] 
              ...
              focus:border-red-500 focus:ring-red-500 transition" name="tanggalterbit" onfocus="(this.type='date')"
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div class="mb-6">
                                ...
                                <input type="text" placeholder="Judul Jurnal" class="
                                w-full
                                                    rounded-md
                                                    border
                                                    border-[#E9EDF4]
                ...
                " name="judul" />
                            ...
                            <div class="mb-6">
                                <label class="text-gray-500 text-sm "> Gambar Representasi <br></label>
            ...
            " /> @error('image')
                        ...
                        <div class="mb-6">
                            ...
                            w-full
                                                    ...
                                                    transition
                                                ">
                                <option class="text-gray-500 text-sm " value="" disabled selected>Pilih kategori
                                </option>
