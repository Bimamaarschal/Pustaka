...
<div class="bg-gray-200 bg-opacity-25 grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8 p-6 lg:p-8">
    ...
    <div>
        ...
        <p class="mt-4 text-gray-500 text-sm leading-relaxed">
            Fitur menulis berita di PUSTAKA memungkinkan Anda untuk menginformasikan dan menyebarkan berita terkini
            dengan akurat dan objektif, memberikan wawasan yang bernilai kepada pembaca.
        </p>
    </div>
</div>

<div class="p-10 lg:p-15 bg-white border-b border-gray-200">
